...
\@x{}\moduleLeftDash\@xx{ {\MODULE} syncCon1}\moduleRightDash\@xx{}%
...
\@x{\@s{57.39} mb \.{=} [ n \.{\in} Nodes \.{\mapsto} \{ \} ] {\p@semicolon}}%
\@pvspace{8.0pt}%
...
\@x{\@s{65.57} {\p@or} {\p@skip} {\p@semicolon} {\p@rbrace} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{20.74} {\p@rbrace}}%
\@pvspace{8.0pt}%
 ...
 {\p@semicolon}}%
\@x{\@s{20.74} {\p@lbrace}}%
 \@x{ P\@s{.5}\textrm{:}\@s{3}\@s{6.65} {\p@if} {\p@lparen} up [ self ]
 {\p@rparen} {\p@lbrace}}%
\@x{\@s{35.38} v \.{:=} self {\p@semicolon}}%
\@x{\@s{35.38} Q \.{:=} Nodes {\p@semicolon}}%
...
\@pvspace{8.0pt}%
 ...
 \.{\in} UpNodes \.{:} pt [ self ] \.{=} pt [ k ] ) ) {\p@semicolon}}%
\@y{%
 \ensuremath{\.{\,\backslash\,}}* Execute receive step only if the node is up
 and all the nodes have reached the next round
}%
\@xx{}%
\@x{\@s{37.14} {\p@lbrace}}%
 ...
 {\p@semicolon}\@s{12.29}}%
\@y{%
 \ensuremath{\.{\,\backslash\,}}* Set the decision to the min of received
 value
}%
\@xx{}%
\@x{\@s{37.14} t [ self ]\@s{1.87} \.{:=} {\TRUE} {\p@semicolon}\@s{53.3}}%
\@y{%
 \ensuremath{\.{\,\backslash\,}}* Terminate the node once it has finalized
 the decision
}%
\@xx{}%
\@x{\@s{37.14} {\p@rbrace}}%
...
\@xx{}%
\@x{ {\VARIABLES} FailNum ,\, up ,\, pt ,\, t ,\, d ,\, mb ,\, pc}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 define statement
...
\@x{\@s{35.70} \.{\land} Q \.{=} [ self \.{\in} Nodes \.{\mapsto} \{ \} ]}%
\@x{\@s{35.70} \.{\land} pc \.{=} [ self \.{\in} ProcSet \.{\mapsto}\@w{P} ]}%
\@pvspace{8.0pt}%
\@x{ P ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{P}}%
\@x{\@s{50.90} \.{\land} {\IF} up [ self ]}%
 \@x{\@s{74.17} \.{\THEN} \.{\land} v \.{'}\@s{2.93} \.{=} [ v {\EXCEPT}
 {\bang} [ self ]\@s{2.93} \.{=} self ]}%
...
\@x{\@s{166.71} \.{\land} pt \.{'} \.{=} pt}%
 ...
 {\rangle}}%
 \@x{\@s{57.56} \.{\land} {\UNCHANGED} {\langle} t ,\, d ,\, v ,\, pv
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ PR ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{PR}}%
 ...
 SetMin ( mb [ self ] ) ]}%
 \@x{\@s{57.56} \.{\land} t \.{'}\@s{1.87} \.{=} [ t {\EXCEPT} {\bang} [ self
 ]\@s{1.87} \.{=} {\TRUE} ]}%
 \@x{\@s{57.56} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Done} ]}%
 \@x{\@s{57.56} \.{\land} {\UNCHANGED} {\langle} FailNum ,\, up ,\, pt ,\, mb
 ,\, v ,\, pv ,\, Q {\rangle}}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{ Inv \.{\defeq} \A\, i ,\, j \.{\in} Nodes \.{:} ( t [ i ] \.{\land} t [
 j ] ) \.{\implies} ( d [ i ] \.{=} d [ j ] )}%
\@pvspace{16.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 24 23:39:13 \ensuremath{EDT} 2017 by Deep
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Oct} 22 13:02:23
 \ensuremath{EDT} 2017 by Deep
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* As it is given in the problem statement,
 every progress broadcasts its initial
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* value \ensuremath{v} to all other nodes in
 one round. After this round, each process decides
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* the minimum value it received among all the
 nodes.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* This is implemented by first defining the
 variables which holds (up, round,
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* termination, decision, and mailbox) values
 of all the nodes. All nodes are ran
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* using strong fairness, so that all the nodes
 get chance to executes its step.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* The whole process is divided into two steps
 – \ensuremath{PS} (process send), and \ensuremath{PR
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* (process receives). When the first round
 beings the process initializes its value (\ensuremath{v})
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* to self id, and \ensuremath{Q} is
 initialized to all the nodes in the system.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}*
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Step \ensuremath{PS}: The process executes
 this step if it is up. During \ensuremath{PS} state process appends
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* its value (\ensuremath{v}) to mailbox of all
 the nodes including itself. It also calls the macro
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* \ensuremath{MaybeFail} (however this will
 not fail any node when \ensuremath{FAILNUM} is set to zero). After sending
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* the value to all the nodes, process moves to
 next round.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}*
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Step \ensuremath{PR}: A node waits for all
 the node to move to next round before executing this step.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Once all the nodes are moved to the next
 round. Current process will find the min of the
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* value received from all the node and set
 this as it\mbox{'}s decision. After this it will terminate
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* To check the validity of the program it will
 satisfy the agreement property.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* As per agreement property - Two correct
 processes can not commit to different decision variables.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* The above program will work if there is no
 failure of nodes. Because all the nodes will reach the
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Step \ensuremath{PR} and wait for other node
 to complete sending message to all. Once all the nodes have completed
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* sending message to all the nodes, all the
 node will decide the minimum value from the messages received.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Since all the nodes are receiving the value
 from all the nodes the decision of all the nodes will be same
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* However, if there is a node failure. The
 failed node might have sent its minimum value to some nodes
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* and failed before sending minimum to all the
 nodes. In this case, if the failed node value was
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* least of all the nodes, the minimum
 calculated by few nodes (who received this value) will differ from others.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Hence the agreement property is violated in
 the current model if there is any failure.
\end{cpar}%
\end{lcom}%
\end{document}
